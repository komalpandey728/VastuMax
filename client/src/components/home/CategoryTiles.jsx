...
const CategoryTiles = () => (
  <section className="py-20 bg-slate-50">
    <div className="container-vastu max">
      ...
      {/* Car sub-categories (Spinny-style pill grid) */}
      <div className="mb-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/buy/cars" className="text-sm font-semibold text-primary-600 hover:underline flex items-center gap-1">
            ...
            <motion.div key={cat.label} variants={fadeUp}>
              <Link to={cat.href}>
                <motion.div
                  ...
                  className={`group rounded-2xl border ${cat.color} bg-white overflow-hidden shadow-soft hover:shadow-md transition-all cursor-pointer`}
                >
                  ...
                  <div className="p-3">
                    <p className="font-bold text-text text-sm">{cat.label}</p>
                    <p className="text-xs text-text-muted mt-0.5">{cat.count} listed</p>
                  </div>
                </motion.div>
              </Link>
            </motion.div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/buy/commercial" className="text-sm font-semibold text-amber-600 hover:underline flex items-center gap-1">
            View all <ArrowRight className="h-3.5 w-3.5" />
          </Link>
        </div>
        <motion.div
            ...
            <motion.div key={cat.label} variants={fadeUp}>
              <Link to={cat.href}>
                <motion.div
                  ...
                  className="group rounded-2xl border border-amber-100 bg-amber-50 overflow-hidden shadow-soft hover:shadow-md transition-all cursor-pointer"
                >
                  <div className="aspect-video overflow-hidden">
                    <img
                      src={cat.img}
                  ...
                  <div className="p-3 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">{cat.count} listed</p>
                    </div>
